...
class Note extends FlxSprite
{
	...
	public static var NOTE_WIDTH:Float = 140;
	public static var NOTE_SIZE:Float = 0.8;
	public static var swagWidth(get, never):Float;
	
	public static function get_swagWidth():Float return NOTE_WIDTH * NOTE_SIZE;
	
	public static var colArray:Array<String> = ['purple', 'blue', 'green', 'red'];
	public static var defaultNoteSkin(default, never):String = 'noteSkins/notes';
	...
	function loadNoteAnims()
	{
		...
		setGraphicSize(Std.int(width * NOTE_SIZE));
		updateHitbox();
	}
