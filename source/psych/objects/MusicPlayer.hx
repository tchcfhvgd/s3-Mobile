 ...
 */
@:access(psych.states.FreeplayState)
class MusicPlayer extends FlxGroup
{
	...
	override function update(elapsed:Float)
	{
		...
		if (paused && !wasPlaying) songTxt.text = 'PLAYING: ' + instance.songGrp.members[FreeplayState.curSelected].songName + ' (PAUSED)';
		else songTxt.text = 'PLAYING: ' + instance.songGrp.members[FreeplayState.curSelected].songName;
	...
	{
		var length:Int = instance.songGrp.members[FreeplayState.curSelected].songName.length;
