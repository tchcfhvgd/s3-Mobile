...
class MenuCharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI()
	{
		...
		imageInputText = new extensions.flixel.FlxUIInputTextEx(10, 20, 80, characterFile.image, 8);
		blockPressWhileTypingOn.push(imageInputText);
		idleInputText = new extensions.flixel.FlxUIInputTextEx(10, imageInputText.y + 35, 100, characterFile.idle_anim, 8);
		blockPressWhileTypingOn.push(idleInputText);
		confirmInputText = new extensions.flixel.FlxUIInputTextEx(10, idleInputText.y + 35, 100, characterFile.confirm_anim, 8);
