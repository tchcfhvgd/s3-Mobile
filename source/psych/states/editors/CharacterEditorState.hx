...
class CharacterEditorState extends MusicBeatState
{
	...
	function addSettingsUI()
	{
		...
		charDropDown = new extensions.flixel.FlxUIDropDownMenuEx(10, 30, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(index:String) {
	...
	function addAnimationsUI()
	{
		...
		animationInputText = new extensions.flixel.FlxUIInputTextEx(15, 85, 80, '', 8);
		animationNameInputText = new extensions.flixel.FlxUIInputTextEx(animationInputText.x, animationInputText.y + 35, 150, '', 8);
		animationIndicesInputText = new extensions.flixel.FlxUIInputTextEx(animationNameInputText.x, animationNameInputText.y + 40, 250, '', 8);
		...
		animationDropDown = new extensions.flixel.FlxUIDropDownMenuEx(15, animationInputText.y - 55, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(pressed:String) {
		...
		var addUpdateButton:FlxButton = new FlxButton(70, animationIndicesInputText.y + 60, "Add/Update", function() {
			...
			for (anim in character.animationsArray) if (animationInputText.text == anim.anim)
			{
	...
	function addCharacterUI()
	{
		...
		imageInputText = new extensions.flixel.FlxUIInputTextEx(15, 30, 200, character.imageFile, 8);
		...
		healthIconInputText = new extensions.flixel.FlxUIInputTextEx(15, imageInputText.y + 35, 75, healthIcon.getCharacter(), 8);
		
		vocalsInputText = new extensions.flixel.FlxUIInputTextEx(15, healthIconInputText.y + 35, 75, character.vocalsFile != null ? character.vocalsFile : '', 8);
	...
	function reloadCharacterDropDown()
	{
		...
		for (folder in foldersToCheck) for (file in FileSystem.readDirectory(folder)) if (file.toLowerCase().endsWith('.json'))
		{
