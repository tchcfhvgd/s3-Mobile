...
class WeekEditorState extends MusicBeatState
{
	...
	function addWeekUI()
	{
		...
		songsInputText = new extensions.flixel.FlxUIInputTextEx(10, 30, 200, '', 8);
		blockPressWhileTypingOn.push(songsInputText);
		
		opponentInputText = new extensions.flixel.FlxUIInputTextEx(10, songsInputText.y + 40, 70, '', 8);
		blockPressWhileTypingOn.push(opponentInputText);
		boyfriendInputText = new extensions.flixel.FlxUIInputTextEx(opponentInputText.x + 75, opponentInputText.y, 70, '', 8);
		blockPressWhileTypingOn.push(boyfriendInputText);
		girlfriendInputText = new extensions.flixel.FlxUIInputTextEx(boyfriendInputText.x + 75, opponentInputText.y, 70, '', 8);
		blockPressWhileTypingOn.push(girlfriendInputText);
		
		backgroundInputText = new extensions.flixel.FlxUIInputTextEx(10, opponentInputText.y + 40, 120, '', 8);
		blockPressWhileTypingOn.push(backgroundInputText);
		
		displayNameInputText = new extensions.flixel.FlxUIInputTextEx(10, backgroundInputText.y + 60, 200, '', 8);
		blockPressWhileTypingOn.push(backgroundInputText);
		
		weekNameInputText = new extensions.flixel.FlxUIInputTextEx(10, displayNameInputText.y + 60, 150, '', 8);
		blockPressWhileTypingOn.push(weekNameInputText);
		
		weekFileInputText = new extensions.flixel.FlxUIInputTextEx(10, weekNameInputText.y + 40, 100, '', 8);
	...
	function addOtherUI()
	{
		...
		weekBeforeInputText = new extensions.flixel.FlxUIInputTextEx(10, hiddenUntilUnlockCheckbox.y + 55, 100, '', 8);
		blockPressWhileTypingOn.push(weekBeforeInputText);
		
		difficultiesInputText = new extensions.flixel.FlxUIInputTextEx(10, weekBeforeInputText.y + 60, 200, '', 8);
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		bg = new FlxSprite().loadGraphic(Paths.image('menu/main/Layer 4'));
	...
	function addFreeplayUI()
	{
		...
		iconInputText = new extensions.flixel.FlxUIInputTextEx(10, bgColorStepperR.y + 70, 100, '', 8);
