...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menu/main/Layer 4'));
	...
	{
		UI_songTitle = new extensions.flixel.FlxUIInputTextEx(10, 10, 70, _song.song, 8);
		...
		var player1DropDown = new extensions.flixel.FlxUIDropDownMenuEx(10, stepperSpeed.y + 45, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String) {
		...
		var gfVersionDropDown = new extensions.flixel.FlxUIDropDownMenuEx(player1DropDown.x, player1DropDown.y + 40, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true),
		...
		var player2DropDown = new extensions.flixel.FlxUIDropDownMenuEx(player1DropDown.x, gfVersionDropDown.y + 40, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true),
			function(character:String) {
		...
		stageDropDown = new extensions.flixel.FlxUIDropDownMenuEx(player1DropDown.x + 140, player1DropDown.y, FlxUIDropDownMenu.makeStrIdLabelArray(stages, true), function(character:String) {
	...
	function addNoteUI():Void
	{
		...
		strumTimeInputText = new extensions.flixel.FlxUIInputTextEx(10, 65, 180, "0");
		...
		noteTypeDropDown = new extensions.flixel.FlxUIDropDownMenuEx(10, 105, FlxUIDropDownMenu.makeStrIdLabelArray(displayNameList, true), function(character:String) {
	...
	function addEventsUI():Void
	{
		...
		eventDropDown = new extensions.flixel.FlxUIDropDownMenuEx(20, 50, FlxUIDropDownMenu.makeStrIdLabelArray(leEvents, true), function(pressed:String) {
		...
		tab_group_event.add(text);
		value1InputText = new extensions.flixel.FlxUIInputTextEx(20, 110, 100, "");
		blockPressWhileTypingOn.push(value1InputText);
		
		var text:FlxText = new FlxText(20, 130, 0, "Value 2:");
		tab_group_event.add(text);
		value2InputText = new extensions.flixel.FlxUIInputTextEx(20, 150, 100, "");
	...
	// Decide to use the psych gameover stuff and turn them into the intro stuff since were just using one gameover thing now
	...
	function addDataUI()
	{
		...
		//
		composerInputText = new extensions.flixel.FlxUIInputTextEx(10, 25, 150, _song.composerName != null ? _song.composerName : '', 8);
		blockPressWhileTypingOn.push(composerInputText);
		
		charterInputText = new extensions.flixel.FlxUIInputTextEx(10, composerInputText.y + 35, 150, _song.charterName != null ? _song.charterName : '', 8);
		blockPressWhileTypingOn.push(charterInputText);
		
		gameOverLoopInputText = new extensions.flixel.FlxUIInputTextEx(10, charterInputText.y + 35, 150, _song.gameOverLoop != null ? _song.gameOverLoop : '', 8);
		blockPressWhileTypingOn.push(gameOverLoopInputText);
		
		gameOverEndInputText = new extensions.flixel.FlxUIInputTextEx(10, gameOverLoopInputText.y + 35, 150, _song.gameOverEnd != null ? _song.gameOverEnd : '', 8);
		...
		//
		noteSkinInputText = new extensions.flixel.FlxUIInputTextEx(10, 280, 150, _song.arrowSkin != null ? _song.arrowSkin : '', 8);
		blockPressWhileTypingOn.push(noteSkinInputText);
		
		noteSplashesInputText = new extensions.flixel.FlxUIInputTextEx(noteSkinInputText.x, noteSkinInputText.y + 35, 150, _song.splashSkin != null ? _song.splashSkin : '', 8);
		...
		tab_group_data.add(charterInputText);
		...
		tab_group_data.add(new FlxText(composerInputText.x, composerInputText.y - 15, 0, 'Song Composer Name:'));
		tab_group_data.add(new FlxText(charterInputText.x, charterInputText.y - 15, 0, 'Song Charter Name:'));
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		...
		else if (id == FlxUIInputText.CHANGE_EVENT && (sender is FlxUIInputText))
		{
			...
			{
				_song.composerName = composerInputText.text;
			}
			else if (sender == charterInputText)
			{
				_song.charterName = charterInputText.text;
			}
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			...
			if (curSelectedNote != null && !(curSelectedNote[1] is Array) && curSelectedNote[1] > -1)
			{
	...
	{
		var isEventNote:Bool = i[1] is Array; // for hl
		
		var daNoteInfo = isEventNote ? 0 : cast i[1];
		var daStrumTime = i[0];
