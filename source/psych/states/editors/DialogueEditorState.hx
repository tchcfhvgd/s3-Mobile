...
class DialogueEditorState extends MusicBeatState
{
	...
	function addDialogueLineUI()
	{
		...
		characterInputText = new extensions.flixel.FlxUIInputTextEx(10, 20, 80, DialogueCharacter.DEFAULT_CHARACTER, 8);
		...
		soundInputText = new extensions.flixel.FlxUIInputTextEx(10, speedStepper.y + 40, 150, '', 8);
		blockPressWhileTypingOn.push(soundInputText);
		
		lineInputText = new extensions.flixel.FlxUIInputTextEx(10, soundInputText.y + 35, 200, DEFAULT_TEXT, 8);
