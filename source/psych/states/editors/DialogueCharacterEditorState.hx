...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	function addAnimationsUI()
	{
		...
		animationDropDown = new extensions.flixel.FlxUIDropDownMenuEx(10, 30, FlxUIDropDownMenu.makeStrIdLabelArray([''], true), function(animation:String) {
		...
		loopInputText = new extensions.flixel.FlxUIInputTextEx(animationInputText.x, animationInputText.y + 35, 150, '', 8);
		blockPressWhileTypingOn.push(loopInputText);
		idleInputText = new extensions.flixel.FlxUIInputTextEx(loopInputText.x, loopInputText.y + 40, 150, '', 8);
	...
	function addCharacterUI()
	{
		...
		imageInputText = new extensions.flixel.FlxUIInputTextEx(10, 30, 80, character.jsonFile.image, 8);
	...
	function reloadCharacter()
	{
		...
		if (character.jsonFile.flipX != null) character.flipX = character.jsonFile.flipX;
	...
	override function update(elapsed:Float)
	{
		...
		if (character != null && ghostIdle != null && ghostLoop != null)
		{
			ghostIdle.flipX = character.flipX;
			ghostLoop.flipX = character.flipX;
		}
