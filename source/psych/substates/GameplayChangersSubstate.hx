...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		{
			var optionText:OptionsText = new OptionsText(50, 360, 0, optionsArray[i].name, 48);
...
{
	private var child:AttachedGenerationsText;
	...
	public function setChild(child:AttachedGenerationsText)
	{
		this.child = child;
	}
