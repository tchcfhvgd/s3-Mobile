...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// Stage
		new psych.states.stages.GreenHill();
		...
		// Characters
		gf = new Character(444, 10, 'amy');
		gf.x += gf.positionArray[0];
		gf.y += gf.positionArray[1];
		gf.scrollFactor.set(0.95, 0.95);
		boyfriend = new Character(720, -67, 'sonic', true);
		...
		timeTxt.setFormat(Paths.font("FOT-NewRodin Pro DB.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		changeModeText.setFormat(Paths.font("FOT-NewRodin Pro DB.otf"), 32, FlxColor.WHITE, CENTER);
	...
	override public function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			FlxG.switchState(() -> new psych.options.OptionsState());
	...
	override public function beatHit()
	{
		...
		if (curBeat % 4 == 2)
		{
			...
			if (zoomTween != null) zoomTween.cancel();
			zoomTween = FlxTween.tween(FlxG.camera, {zoom: 1.2}, 1,
				{
	...
	function createTexts()
	{
		for (i in 0...4)
		{
			...
			text.setFormat(Paths.font("FOT-NewRodin Pro DB.otf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
