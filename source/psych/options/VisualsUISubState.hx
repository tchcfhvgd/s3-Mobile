...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		{
			if (!noteSkins.contains(ClientPrefs.data.noteSkin)) ClientPrefs.data.noteSkin = ClientPrefs.defaultData.noteSkin; // Reset to default if saved noteskin couldnt be found
		...
		var option:Option = new Option('Show Combos', "If unchecked, hides the combos on screen", 'showCombo', 'bool');
		addOption(option);
