...
class WeekData
{
	...
	public function new(weekFile:WeekFile, fileName:String)
	{
		...
		for (field in Reflect.fields(weekFile)) if (Reflect.fields(this).contains(field)) // Reflect.hasField() won't fucking work :/
